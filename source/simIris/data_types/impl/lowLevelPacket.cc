...
//                flits.push_back(hf);
                ...
                this->vn = hf->vn;
                this->virtual_source = hf->virtual_source;
                this->hf_is_pseudo = hf->pseudo;
                this->path =  hf->path;
                this->node_stamping = hf->node_stamping;
                this->ps_length = hf->ps_length;
                ...
                this->in_packet_arrival=Simulator::Now();
...
//                flits.push_back(tf);
                ...
                this->tf_is_pseudo = tf->pseudo;
                this->tf_is_valid  = tf->valid;
                delete tf;
                tf=NULL;
                break;
            }

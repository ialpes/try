...
class Router : public NetworkComponent
{
	...
	/* For visualization */
        ...
        virtual double get_packets_drop() {};
        virtual double get_pshf_created() {};
        virtual double get_pstf_created() {};
	/* end */
        ...
        virtual void find_neighbors(uint ports, uint vcs, uint credits, uint buffer_size)=0;
        virtual void set_fault(uint p)=0;
        virtual void set_temp_ipfault(uint p,double t,ullint d)=0;
        virtual void set_temp_opfault(uint p,double t,ullint d)=0;

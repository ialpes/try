...
#ifndef _genericPktGenVn_cc_INC
#define _genericPktGenVn_cc_INC

#include "genericPktGenVn.h"
...
GenericPktGenVn::GenericPktGenVn ()
{
    name = "GenericPktGenVn";
    sending = false;
    out_filename = "traceOut.tr";
    last_vc = 0;
    ni_recv = false;
    srand( time(NULL) );
} /* ----- end of function GenericPktGenVn::GenericPktGenVn ----- */
...
void
GenericPktGenVn::set_trace_filename( string filename )
{
    trace_name = filename;
...
void
GenericPktGenVn::set_no_vcs ( uint v)
{
    vcs = v;
}

void
GenericPktGenVn::log_enable ()
{
#ifdef _LOG
	flag_enable = true;
#endif
...
void
GenericPktGenVn::enable (uint v, bool enable) // yi:modified to add a flag (0:disable, 1:enable)
{
    vcs =v;
...
//    flag_enable = true;
    ...
    return ;
} /* ----- end of function GenericPktGenVn::setup ----- */


void
GenericPktGenVn::setup (uint n, uint v, uint time)
{
    vcs =v;
    no_nodes = n;
    max_sim_time = time;
...
void
GenericPktGenVn::set_output_path( string name)
{
	if (flag_enable)
	{
...
GenericPktGenVn::finish ()
{
    ...
    return ;
} /* ----- end of function GenericPktGenVn::finish ----- */

void
GenericPktGenVn::process_event (IrisEvent* e)
{
    switch(e->type)
    {
        case NEW_PACKET_EVENT:
#ifdef _DEBUG
            _DBG("; GenericPktGenVn::NEW_PACKET_EVENT ; time:%f", Simulator::Now());
#endif
        	handle_new_packet_event(e);
            break;
        case OUT_PULL_EVENT:
#ifdef _DEBUG
            _DBG("; GenericPktGenVn::OUT_PULL_EVENT ; time:%f", Simulator::Now());
#endif
            handle_out_pull_event(e);
            break;
        case READY_EVENT:
#ifdef _DEBUG
            _DBG("; GenericPktGenVn::READY_EVENT ; time:%f", Simulator::Now());
#endif
            handle_ready_event(e);
            break;
        case RESET_STAT_EVENT:
#ifdef _DEBUG
            _DBG("; GenericPktGenVn::RESET_STAT_EVENT time:%f", Simulator::Now());
#endif
        	handle_reset_stat_event(e);
            break;
        case VS_PKT_ARRIVAL_EVENT:
#ifdef _DEBUG
            _DBG("; GenericPktGenVn::VS_PKT_ARRIVAL_EVENT time:%f", Simulator::Now());
#endif
    ...
    return ;
} /* ----- end of function GenericPktGenVn::process_event ----- */


void
GenericPktGenVn::handle_new_packet_event ( IrisEvent* e)
{
//#ifdef _DEBUG
//       _DBG("; GenericPktGenVn::handle_new_packet_event at time=%f ", Simulator::Now());
//#endif
    ...
    {
//    	cerr << "GenericPktGenVn: virtual_source arrived: "<< hlp->toString();
...
} /* ----- end of function GenericPktGenVn::handle_new_packet_event ----- */

void
GenericPktGenVn::handle_vs_pkt_arrival_event ( IrisEvent* e )
{
    // change vn, vs
	HighLevelPacket* hlp = static_cast< HighLevelPacket* >( e->event_data.at(0));
    ...
    {
    	//cerr << "GenericPktGenVn: no available vc for vs_pkt"<<endl;
...
void
GenericPktGenVn::handle_out_pull_event ( IrisEvent* e )
{
    sending =false;
    bool found = false;
    uint sending_vc = -1;
...
void
GenericPktGenVn::handle_ready_event ( IrisEvent* e)  // got ready event from NI which means it is ready to accept new pkt, reset available vc
{
...
//#endif
    ...
    delete e; e=NULL;
    return ;
} /* ----- end of function GenericPktGenVn::handle_ready_event ----- */
uint
GenericPktGenVn::node_transpose()
{
...
void
GenericPktGenVn::handle_reset_stat_event( IrisEvent* e)
{
    stat_packets_in = 0;
    stat_packets_out = 0;
    stat_min_pkt_latency = 999999999;
...
ullint
GenericPktGenVn::get_average_packet_latency()
{
...
ullint
GenericPktGenVn::get_vs_packet_out()
{
...
ullint
GenericPktGenVn::get_packets_out()
{
	if (stat_packets_out==0) return 0;
	else
	    return stat_packets_out;
}
ullint
GenericPktGenVn::get_packets_in()
{
	if (stat_packets_in==0) return 0;
	else
	    return stat_packets_in;
}
string
GenericPktGenVn::toString () const
{
    stringstream str;
    str << "\nGenericPktGenVn: "
        << "\t vcs: " << ready.size()
        ...
        ;
    return str.str();
} /*  ----- end of function GenericPktGenVn::toString ----- */

string
GenericPktGenVn::print_stats() const
{
    stringstream str;
...
#endif /* ----- #ifndef _genericPktGenVn_cc_INC ----- */

 ...
 * =====================================================================================
 *
 *       Filename:  genericInterfaceNBpr.h
 *
...
#ifndef  _genericInterfaceNBpr_h_INC
#define  _genericInterfaceNBpr_h_INC
...
extern vector<void *> ptr_router;
//extern Topology * topology_ptr;

using namespace std;

class GenericInterfaceNBpr : public Interface
{
    public:
        GenericInterfaceNBpr();                             /* constructor */
        ~GenericInterfaceNBpr();                             /* constructor */
...
}; /* -----  end of class GenericInterfaceNBpr  ----- */

#endif   /* ----- #ifndef _GenericInterfaceNBpr_h_INC  ----- */

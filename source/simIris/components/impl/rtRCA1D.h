...
#ifndef  _rtRCA1D_h_INC
#define  _rtRCA1D_h_INC
...
class RtRCA1D: public Router
{
    ...
    private:
        ...
        void handle_dbar_arrival_event(IrisEvent* e);
...
}; /* -----  end of class RtRCA1D  ----- */

#endif   /* ----- #ifndef _rtRCA1D_h_INC  ----- */

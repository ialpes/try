...
#ifndef  _rtPKTPRtr_h_INC
#define  _rtPKTPRtr_h_INC
...
class RtPKTPRtr: public Router
{
    public:
        RtPKTPRtr ();                             /*! constructor */
        ~RtPKTPRtr();                             /*! destructor */
...
}; /* -----  end of class RtPKTPRtr  ----- */

#endif   /* ----- #ifndef _rtPKTPRtr_h_INC  ----- */

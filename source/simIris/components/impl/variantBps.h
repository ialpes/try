...
#ifndef  _variantBps_h_INC
#define  _variantBps_h_INC
...
class VariantBps: public Router
{
    public:
        VariantBps ();                             /*! constructor */
        ~VariantBps();                             /*! destructor */
...
}; /* -----  end of class VariantBps  ----- */

#endif   /* ----- #ifndef _variantBps_h_INC  ----- */

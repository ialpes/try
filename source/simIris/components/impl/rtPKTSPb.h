...
#ifndef  _rtPKTSPb_h_INC
#define  _rtPKTSPb_h_INC
...
class RtPKTSPb: public Router
{
    public:
        RtPKTSPb ();                             /*! constructor */
        ~RtPKTSPb();                             /*! destructor */
    ...
    private:
        ...
        vector < vector <uint*> > fon;
        vector<uint>  local_ft;
        vector < vector <uint*> > cgmon;
        vector<uint>  local_cgm;
...
}; /* -----  end of class RtPKTSPb  ----- */

#endif   /* ----- #ifndef _rtPKTSPb_h_INC  ----- */

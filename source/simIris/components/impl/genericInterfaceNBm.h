 ...
 * =====================================================================================
 *
 *       Filename:  genericInterfaceNBm.h
 *
...
#ifndef  _genericInterfaceNBm_h_INC
#define  _genericInterfaceNBm_h_INC
...
class GenericInterfaceNBm : public Interface
{
    public:
        GenericInterfaceNBm();                             /* constructor */
        ~GenericInterfaceNBm();                             /* constructor */
    ...
    private:
        ...
        vector <bool > is_requested;// if a in_buffer[] has made request, index by in_buffer[]
        vector <uint > in_channel;  // store a distributed channel in_packets[] for a in_buffer[], index by in_buffer[]
...
}; /* -----  end of class GenericInterfaceNBm  ----- */

#endif   /* ----- #ifndef _GenericInterfaceNBm_h_INC  ----- */

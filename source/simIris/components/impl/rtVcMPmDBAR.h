...
#ifndef  _rtVcMPmDBAR_h_INC
#define  _rtVcMPmDBAR_h_INC
...
class RtVcMPmDBAR: public Router
{
    public:
        RtVcMPmDBAR ();                             /*! constructor */
        ~RtVcMPmDBAR();                             /*! destructor */
...
}; /* -----  end of class RtVcMPmDBAR  ----- */

#endif   /* ----- #ifndef _rtVcMPmDBAR_h_INC  ----- */

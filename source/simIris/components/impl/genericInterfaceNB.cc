...
void
GenericInterfaceNB::set_buffer_size( uint vcs, uint bs )
{
...
GenericInterfaceNB::process_event(IrisEvent* e)
{
    switch(e->type)
    {
        ...
        case READY_EVENT:
#ifdef _DEBUG
            _DBG("; GenericInterfaceNB::READY_EVENT time:%f", Simulator::Now());
#endif
...
#ifdef _DEBUG
            _DBG("; GenericInterfaceNB::LINK_ARRIVAL_EVENT time:%f", Simulator::Now());
#endif
...
#ifdef _DEBUG
            _DBG("; GenericInterfaceNB::NEW_PACKET_EVENT time:%f", Simulator::Now());
#endif
        ...
        case TICK_EVENT:
#ifdef _DEBUG
            _DBG("; GenericInterfaceNB::TICK_EVENT time:%f", Simulator::Now());
#endif
            handle_tick_event(e);
            break;
...
#ifdef _DEBUG
            _DBG("; GenericInterfaceNB::send credit back time:%f", Simulator::Now());
#endif
...
GenericInterfaceNB::handle_tick_event(IrisEvent* e)
{
    ...
    {
#ifdef _DEBUG
            _DBG("; GenericInterfaceNB::found && pkt_fnd:%f", Simulator::Now());
#endif
...
ullint
GenericInterfaceNB::get_flits_in()
{
    return flits_in;
}

ullint
GenericInterfaceNB::get_packets_in()
{
    return packets_in;
}
...
ullint
GenericInterfaceNB::get_packets_drop()
{

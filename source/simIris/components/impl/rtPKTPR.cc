...
#ifndef  _rtPKTPR_cc_INC
#define  _rtPKTPR_cc_INC
...
RtPKTPR::RtPKTPR ()
{
    name = "RtPKTPR" ;
    ticking = false;
}  /* -----  end of method RtPKTPR::RtPKTPR  (constructor)  ----- */
...
void
RtPKTPR::find_neighbors(uint p, uint v, uint cr, uint bs)
{
    ports =p;
    vcs =v;
    credits =cr;
...
void
RtPKTPR::set_temp_fault(uint p,uint type)
{
...
void
RtPKTPR::remove_fault(uint p,uint type)
{
	if(type==6000)
...
void
RtPKTPR::set_temp_opfault(uint p, double t, ullint d)
{
...
void
RtPKTPR::set_temp_ipfault(uint p, double t, ullint d)
{
    IrisEvent* event = new IrisEvent();
    event->type = FAULT_INJECT_EVENT;
...
void
RtPKTPR::handle_fault_remove_event(IrisEvent* e )
{
...
void
RtPKTPR::handle_fault_inject_event(IrisEvent* e )
{
#ifdef _DEBUG_FI
	if(e->src_id==6000)
	{
...
void
RtPKTPR::init (uint p, uint v, uint cr, uint bs)
{
    ports =p;
    vcs =v;
    credits =cr;
...
void
RtPKTPR::set_grid_x_location( uint port, uint x_node, uint value)
{
...
void
RtPKTPR::set_grid_y_location( uint port, uint y_node, uint value)
{
...
void
RtPKTPR::process_event ( IrisEvent* e )
{
    switch(e->type)
    {
        case LINK_ARRIVAL_EVENT:
#ifdef _DEBUG_ROUTER
        	_DBG_NOARG("; RtPKTPR::LINK_ARRIVAL_EVENT ;");
#endif
            handle_link_arrival_event(e);
            break;
        case TICK_EVENT:
#ifdef _DEBUG_ROUTER
        	_DBG_NOARG("; RtPKTPR::TICK_EVENT ;");
#endif
            handle_tick_event(e);
            break;
        case CHECK_EVENT:
#ifdef _DEBUG_ROUTER
        	_DBG_NOARG("; RtPKTPR::CHECK_EVENT ;");
#endif
            handle_check_event(e);
            break;
        case DETECT_DEADLOCK_EVENT:
#ifdef _DEBUG_ROUTER
        	_DBG_NOARG("; RtPKTPR::DETECT_DEADLOCK_EVENT ;");
#endif
            handle_detect_deadlock_event(e);
            break;
        case FAULT_INJECT_EVENT:
#ifdef _DEBUG_ROUTER
        	_DBG_NOARG("; RtPKTPR::FAULT_INJECT_EVENT ;");
#endif
            handle_fault_inject_event(e);
            break;
        case FAULT_REMOVE_EVENT:
#ifdef _DEBUG_ROUTER
        	_DBG_NOARG("; RtPKTPR::FAULT_REMOVE_EVENT ;");
#endif
            handle_fault_remove_event(e);
            break;
        case RESET_STAT_EVENT:
#ifdef _DEBUG_ROUTER
        	_DBG_NOARG("; RtPKTPR::RESET_STAT_EVENT ;");
#endif
        	handle_reset_stat_event(e);
            break;

        default:
            _DBG(";RtPKTPR:: Unk event exception %d", e->type);
            break;
    }
    return ;
}		/* -----  end of function RtPKTPR::process_event  ----- */
void
RtPKTPR::handle_check_event (IrisEvent* e)
{
...
void 
RtPKTPR::handle_detect_deadlock_event(IrisEvent* e )
{
    for ( uint i=0; i<ports; i++)
        for ( uint j=0; j<vcs; j++)
        {
...
double RtPKTPR::get_average_packet_latency()
{
	return ((stat_total_packet_latency+0.0)/stat_packets);
}

double RtPKTPR::get_last_flit_out_cycle()
{
	return last_flit_out_cycle;
}

double RtPKTPR::get_flits_per_packet()
{
	return (stat_flits+0.0)/(stat_packets) ;
}

double RtPKTPR::get_buffer_occupancy()
{
	return stat_buffer_occupancy;	
}

double RtPKTPR::get_packets_drop()
{
	return stat_pkts_drop;
}

double RtPKTPR::get_pshf_created()
{
	return stat_pshf_created;
}
double RtPKTPR::get_pstf_created()
{
	return stat_pstf_created;
}
double RtPKTPR::get_swa_fail_msg_ratio()
{
	return stat_swa_fail_msg_ratio;	
}

double RtPKTPR::get_swa_load()
{
	return stat_swa_load;
}

double RtPKTPR::get_vca_fail_msg_ratio()
{
	return stat_vca_fail_msg_ratio;
}

double RtPKTPR::get_vca_load()
{
	return stat_vca_load;
}
 
double RtPKTPR::get_stat_packets()
{
	return stat_packets;	
}

double RtPKTPR::get_stat_flits()
{
	return stat_flits;
}

double RtPKTPR::get_stat_ib_cycles()
{
	return stat_ib_cycles;	
}

double RtPKTPR::get_stat_rc_cycles()
{
	return stat_rc_cycles;
}

double RtPKTPR::get_stat_vca_cycles()
{
	return stat_vca_cycles;
}
        
double RtPKTPR::get_stat_swa_cycles()
{
	return stat_swa_cycles;
}
 
double RtPKTPR::get_stat_st_cycles()
{
...
void
RtPKTPR::handle_link_arrival_event ( IrisEvent* e )
{
    ...
    delete e; e=NULL;
    return ;
}		/* -----  end of function RtPKTPR::handle_link_arrival_event  ----- */

void
RtPKTPR::handle_reset_stat_event( IrisEvent* e)
{
    /* init the countes */
    stat_packets = 0;
    stat_flits = 0;
...
//                                _DBG("; do_input_buffering %d ft%d",inport*vcs+invc, f->type);
                ...
                if( f->type == HEAD )
                {
                    	...
                    	//input_buffer_state[inport*vcs+f->vc].copy_hf = hf;
                    {
                    	...
                    	*bk_hf = *hf;
                    	input_buffer_state[i].copy_hf=bk_hf;
#ifdef _DEBUG_MEMORY
...
#ifdef _DEBUG_PKTRJ
						_DBG("; IB pkt rejoin found ;  addr %lld; 0x%x; Head",static_cast<HeadFlit*>(f)->addr,f);
#endif
                    	}
                    }
				...
				if (!found_opfault)
				{
					if(f->type == TAIL && f->pseudo && f->valid)
					{
						...
						IrisEvent* event = new IrisEvent();
												event->type = CHECK_EVENT;
												event->time = 400;
												Simulator::Schedule( Simulator::Now()+150,
														&NetworkComponent::process_event, this, event);
...
#endif
#ifdef _DEBUG_PKT
						_DBG("; Router ST; Flit Out ; delete copy_hf addr %lld; 0x%x;",
								static_cast<HeadFlit*>(input_buffer_state[i].copy_hf)->addr,
								input_buffer_state[i].copy_hf);
#endif
						delete input_buffer_state[i].copy_hf;
...
RtPKTPR::do_vca()
{
    ...
    for( uint i=0; i< ports; ++i) //i=output port
        for ( uint ai=0; ai<vca.current_winners.at(i).size(); ++ai) //ai=output channel
        {
#ifdef _DEBUG_ROUTER
            ...
            {
#ifdef _DEBUG_VCA
                _DBG("; VCA ; COMP; ip%d_ic%d_op%d_oc%d; ",ip,ic,op,oc);
#endif
            	tot_vca_req++;
            	assert(curr_msg.output_port == op);
                curr_msg.output_port = op;
                assert(curr_msg.output_channel == oc);
...
void
RtPKTPR::handle_tick_event ( IrisEvent* e )
{
    ticking = false;
    //do_switch_traversal();
    do_st();
            	...
            	if (input_buffer_state[i].is_pktrj == true)
            	{
            		...
            		if (pkt_found)
            		{
            			...
            			if(input_buffer_state[found_ibs].pipe_stage==ROUTED)
            			{
            				...
            				input_buffer_state[i].is_pseudo_hf_created=input_buffer_state[found_ibs].is_pseudo_hf_created;
            				input_buffer_state[i].is_pseudo_tf_created=input_buffer_state[found_ibs].is_pseudo_tf_created;
            				input_buffer_state[i].sent_head=input_buffer_state[found_ibs].sent_head;
            				// substitute copy_hf
#ifdef _DEBUG_ROUTER_HEAD
            				_DBG("; Router TICK; pkt found ; delete copy_hf addr %lld; 0x%x;",
            						static_cast<HeadFlit*>(input_buffer_state[i].copy_hf)->addr,
            						input_buffer_state[i].copy_hf);
#endif
#ifdef _DEBUG_MEMORY
                    _DBG("; PKT PR; delete bk_hf; addr=%lld; 0x%x",input_buffer_state[i].copy_hf->addr, input_buffer_state[i].copy_hf);
#endif
            				delete  input_buffer_state[i].copy_hf;

            				input_buffer_state[i].copy_hf=input_buffer_state[found_ibs].copy_hf;
            				input_buffer_state[i].copy_hf->vc=tic;
...
#ifdef _DEBUG_VCA
                        	 _DBG("; VCA ; REQUEST; ip%d_ic%d_op%d_oc%d; pktrj ",tip,tic,top,toc);
#endif
            		...
            		else // not found (pkt could be dropped because of timeout), then drop
            		{

            			if( in_buffers[tip].get_occupancy(tic)>0 )//|| input_buffer_state[i].is_pseudo_hf_created)
            			{
            				Flit* f;
            				/*if(input_buffer_state[i].is_pseudo_hf_created)
            				{
            					f = input_buffer_state[i].copy_hf;
#ifdef _DEBUG_MEMORY
                    _DBG("; TICK; delete bk_hf; addr=%lld; 0x%x",input_buffer_state[i].copy_hf->addr, input_buffer_state[i].copy_hf);
#endif
            				}
            				else*/
            				{
            				...
            				if(f->type ==HEAD && f->pseudo==false)//!(input_buffer_state[i].is_pseudo_hf_created ))
            				{
            					stat_pkts_drop++;
#ifdef _DEBUG_FI
            					_DBG("; OP Fault found during RC Drop Psdueo Flit Head of %lld; 0x%x ", static_cast<HeadFlit*>(f)->addr,f);
#endif
            				}
            				if(f->type ==TAIL || f->is_single_flit_pkt )
            				{
            					input_buffer_state[i].clear_message = true;
            					if(in_buffers[tip].get_occupancy(tic) > 0)
            						input_buffer_state[i].pipe_stage = FULL;
            					else
            						input_buffer_state[i].pipe_stage = EMPTY;
            					//vc_alloc[op].push_back(oc);
...
#ifdef _DEBUG_FI
            				_DBG("; PKT REJOIN NODE not found pkt ; ip_%d*vcs_%d+ic_%d(=%d) ft=%d",tip,vcs,tic,tip*vcs+tic, f->type);
            				if(f->type ==HEAD)
            				{
            					_DBG("; TICK ; Drop Flit HEAD ; addr %lld; 0x%x Head;",static_cast<HeadFlit*>(f)->addr,f);
            				}
            				else if(f->type ==BODY)
            				{
            					_DBG("; TICK ; Drop Flit BODY ; addr %lld; 0x%x Body;",static_cast<BodyFlit*>(f)->addr,f);
            				}
            				else if(f->type ==TAIL)
            				{
            					_DBG("; TICK ; Drop Flit TAIL ; addr %lld; 0x%x Tail;",static_cast<TailFlit*>(f)->addr,f);
            				}
#endif
            	...
            	//if( downstream_credits[op][oc]>0)
           		{
            		...
            		input_buffer_state[i].output_channel = oc;
#ifdef _DEBUG_VCA
                        	 _DBG("; VCA ; REQUEST; ip%d_ic%d_op%d_oc%d; ",ip,ic,op,oc);
#endif
/*#ifdef _DEBUG_ROUTER
        	...
        	_DBG("; Router ; Drop Flit TAIL ; addr %lld; 0x%x Tail;",static_cast<TailFlit*>(f)->addr,f);
                    ...
                    if(f->type ==TAIL || f->is_single_flit_pkt )
                    {
        	    	    ...
        	    	    input_buffer_state[i].possible_oports.clear();
        	    	        ...
        	    	        {
#ifdef _DEBUG_ROUTER_HEAD
            				_DBG("; Router TICK; pkt drop ; delete copy_hf addr %lld; 0x%x;",
            						static_cast<HeadFlit*>(input_buffer_state[i].copy_hf)->addr,
            						input_buffer_state[i].copy_hf);
#endif
        	    	        	delete input_buffer_state[i].copy_hf;
...
}		/* -----  end of function RtPKTPR::handle_input_arbitration_event  ----- */

string
RtPKTPR::toString() const
{
    stringstream str;
    str << "RtPKTPR"
        << "\t addr: " << address
...
void
RtPKTPR::send_credit_back(uint i)
{
        ...
        if( input_buffer_state[i].pipe_stage == IB )
        {
        	...
        	if ( input_buffer_state[i].possible_oports.size() == 2 )
        	{
                ...
                for ( uint i=0; i<no_adaptive_aports; i++ )
                {
                    ...
                    if( static_cast<RtPKTPR*>(static_cast<GenericLink*>(output_connections[porta])->output_connection)->neighbors[rc_port] != NULL )  // should check if exits
                    {
                    	a_aoc.push_back(rc_port);
                     temp=static_cast<RtPKTPR*>(static_cast<GenericLink*>(output_connections[porta])->output_connection)->get_sum_bf(rc_port);
                ...
                for ( uint i=0; i<no_adaptive_bports; i++ )
                {
                    ...
                    if( static_cast<RtPKTPR*>(static_cast<GenericLink*>(output_connections[portb])->output_connection)->neighbors[rc_port] != NULL )  // should check if exits
                    {
                        b_aoc.push_back(rc_port);
                        temp=static_cast<RtPKTPR*>(static_cast<GenericLink*>(output_connections[portb])->output_connection)->get_sum_bf(rc_port);

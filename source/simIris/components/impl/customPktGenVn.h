...
#ifndef  _customPktGenVn_h_INC
#define  _customPktGenVn_h_INC
...
extern ullint sim_warmup_time;

class CustomPktGenVn : public Processor
{
    ...
    private:
        ...
        void handle_warmup_event(IrisEvent* e);
        void handle_one_pull_event(IrisEvent* e);
...
#endif   /* ----- #ifndef _customPktGenVn_h_INC  ----- */

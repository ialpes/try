 ...
 * =====================================================================================
 *
 *       Filename:  genericInterfaceNBVs.cc
 *
...
#ifndef  _genericInterfaceNBVs_cc_INC
#define  _genericInterfaceNBVs_cc_INC

#include	"genericInterfaceNBVs.h"
...
GenericInterfaceNBVs::GenericInterfaceNBVs()
{
    name = "GenericInterfaceNBVs";
    ticking =false;
}		/* -----  end of function GenericInterfaceNBVs::GenericInterfaceNBVs  ----- */
...
void
GenericInterfaceNBVs::setup (uint v, uint cr, uint bs)
{
    vcs =v;
    credits = cr;
    buffer_size = bs;
...
//    convert_packet_cycles = DEFAULT_CONVERT_PACKET_CYCLES;
    ...
    return;
}		/* -----  end of function GenericInterfaceNBVs::setup  ----- */
void
GenericInterfaceNBVs::handle_check_event (IrisEvent* e)
{
	for(uint i=0; i<vcs; i++)
	{
		...
		if(!in_packets_ready[i])
		{
			...
			if(waiting_time > e->time)
			{
				...
				if(ibch != -1)
				{
					...
					{
						_DBG("; check event; pkt %lld is dropped at NI due to large waiting time %lld",in_packets[i].addr, waiting_time);
						in_packets[i].clear();
						in_packets[i].addr=-1;
						in_packets_ready[i] = true;
						is_equal[i] = true;
...
string
GenericInterfaceNBVs::toString () const
{
    stringstream str;
    str << "GenericInterfaceNBVs: "
        << "\t VC: " << out_packets.size()
        ...
        ;
    return str.str();
}		/* -----  end of function GenericInterfaceNBVs::toString  ----- */

void
GenericInterfaceNBVs::set_no_credits( int cr )
{
}		/* -----  end of function GenericInterfaceNBVs::toString  ----- */

uint
GenericInterfaceNBVs::get_no_credits() const
{
    return credits;
}		/* -----  end of function GenericInterfaceNBVs::toString  ----- */

void
GenericInterfaceNBVs::set_no_vcs( uint cr )
{
}		/* -----  end of function GenericInterfaceNBVs::toString  ----- */

void
GenericInterfaceNBVs::set_buffer_size( uint cr )
{
}		/* -----  end of function GenericInterfaceNBVs::toString  ----- */
void
GenericInterfaceNBVs::set_buffer_size( uint vcs, uint bs )
{
    in_buffer.resize(vcs, bs);
    out_buffer.resize(vcs, bs);
}		/* -----  end of function GenericInterfaceNBVs::toString  ----- */
void
GenericInterfaceNBVs::process_event(IrisEvent* e)
{
    switch(e->type)
    {
        ...
        case READY_EVENT:
#ifdef _DEBUG
            _DBG("; GenericInterfaceNBVs::READY_EVENT ; time:%f", Simulator::Now());
#endif
...
#ifdef _DEBUG
            _DBG("; GenericInterfaceNBVs::LINK_ARRIVAL_EVENT ; time:%f", Simulator::Now());
#endif
...
#ifdef _DEBUG
            _DBG("; GenericInterfaceNBVs::NEW_PACKET_EVENT ; time:%f", Simulator::Now());
#endif
        ...
        case TICK_EVENT:
#ifdef _DEBUG
            _DBG("; GenericInterfaceNBVs::TICK_EVENT ; time:%f", Simulator::Now());
#endif
            handle_tick_event(e);
            break;
...
#ifdef _DEBUG
            _DBG("; GenericInterfaceNBVs::RESET_STAT_EVENT time:%f", Simulator::Now());
#endif
        ...
        case VS_TICK_EVENT:
#ifdef _DEBUG
            _DBG("; GenericInterfaceNBVs::VS_TICK_EVENT time:%f", Simulator::Now());
#endif
        ...
        case CHECK_EVENT:
#ifdef _DEBUG
            _DBG("; GenericInterfaceNBVs::CHECK_EVENT time:%f", Simulator::Now());
#endif
...
}		/* -----  end of function GenericInterfaceNBVs::process_event ----- */

void
GenericInterfaceNBVs::handle_ready_event( IrisEvent* e)
{
...
if( in_ready[e->vc] )
{
    ...
    delete e;e=NULL;
    return;
}		/* -----  end of function GenericInterfaceNBVs::handle_ready_event  ----- */

void
GenericInterfaceNBVs::handle_link_arrival ( IrisEvent* e)
{
...
*/
    ...
    if(!ticking)
    {
        ...
        new_event->vc = e->vc;
        Simulator::Schedule( floor(Simulator::Now())+1, &GenericInterfaceNBVs::process_event, this, new_event);
    }
    delete uptr; uptr=NULL;
    delete e; e=NULL;
    return;
}		/* -----  end of function GenericInterfaceNBVs::handle_link_arrival  ----- */

void
GenericInterfaceNBVs::handle_new_packet_event(IrisEvent* e)
{
...
//    delete pkt;
    ...
    delete e; e=NULL;
    return;
}		/* -----  end of function GenericInterfaceNBVs::handle_new_packet_event  ----- */

void
GenericInterfaceNBVs::handle_reset_stat_event( IrisEvent* e)
{
    /*  init stats */
    packets_out = 0;
    vs_packets_in = 0;
...
void
GenericInterfaceNBVs::handle_vs_tick_event(IrisEvent* e)
{
...
void
GenericInterfaceNBVs::handle_tick_event(IrisEvent* e)
{
    ticking = false;
...
*/
    ...
    if ( found && pkt_fnd )
    {
        if(!static_cast<Processor*>(processor_connection)->ni_recv)
        {
			...
			if(ibch != -1)// change to assert(ibch != -1)
			{
    	...
    	if (! in_packets_ready[i]) // for those in_packets is not ready
    	{
    		...
    		if(!is_vs[i])
    		{
    			...
    			if(found_rest)
    			{
    				...
    				is_requested_inbf[found_channel] = true;// j: in buffer channel
    				inpkt_ch_for_inbf[found_channel] = i;   // i: in pkt channel
    				ticking = true;
    				break;
    			}
...
string
GenericInterfaceNBVs::print_stats()
{
    stringstream str;
...
ullint
GenericInterfaceNBVs::get_flits_in()
{
    return flits_in;
}

ullint
GenericInterfaceNBVs::get_flits_out()
{
    return flits_out;
}

ullint
GenericInterfaceNBVs::get_packets_out()
{
    return packets_out;
}
ullint
GenericInterfaceNBVs::get_vs_packets_in()
{
    return vs_packets_in;
}
ullint
GenericInterfaceNBVs::get_packets_in()
{
    return packets_in;
}

ullint
GenericInterfaceNBVs::get_packets()
{
    return packets_out + packets_in;
}
ullint
GenericInterfaceNBVs::get_packets_drop()
{
    return stat_pkts_drop;
}
#endif   /* ----- #ifndef _GenericInterfaceNBVs_cc_INC  ----- */

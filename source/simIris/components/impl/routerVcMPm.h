...
#ifndef  _routerVcMPm_h_INC
#define  _routerVcMPm_h_INC
...
class RouterVcMPm: public Router
{
    public:
        RouterVcMPm ();                             /*! constructor */
        ~RouterVcMPm();                             /*! destructor */
	...
	double get_last_flit_out_cycle();
        ...
        void remove_fault(uint p);

        /* DBAR */
        vector <uint> metric_x;
        vector <uint> metric_y;
        vector <uint> metric_index;
        vector <bool> to_propagate;
        /* RCA */
        vector <uint> cvr; // congestion value register
        vector <uint> nlcvr; // non local congestion value register
        vector <uint> pvr; // propagation value register
    ...
    private:
        ...
        //vector< vector< uint> > vc_alloc;
        vector< vector< uint> > sw_alloc;
        vector< vector <uint> >request_op;
        vector< deque <uint> >request_output;
        ...
        void do_virtual_channel_allocation_m();
        void do_vca();
        void do_swa();
        void do_st();
...
}; /* -----  end of class RouterVcMPm  ----- */

#endif   /* ----- #ifndef _routerVcMPm_h_INC  ----- */

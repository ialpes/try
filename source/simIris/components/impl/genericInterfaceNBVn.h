 ...
 * =====================================================================================
 *
 *       Filename:  genericInterfaceNBVn.h
 *
...
#ifndef  _genericInterfaceNBVn_h_INC
#define  _genericInterfaceNBVn_h_INC
...
class GenericInterfaceNBVn : public Interface
{
    public:
        GenericInterfaceNBVn();                             /* constructor */
        ~GenericInterfaceNBVn();                             /* constructor */
...
}; /* -----  end of class GenericInterfaceNBVn  ----- */

#endif   /* ----- #ifndef _GenericInterfaceNBVn_h_INC  ----- */

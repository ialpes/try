 ...
 * =====================================================================================
 *
 *       Filename:  genericInterfaceNBVs.h
 *
...
#ifndef  _genericInterfaceNBVs_h_INC
#define  _genericInterfaceNBVs_h_INC
...
class GenericInterfaceNBVs : public Interface
{
    public:
        GenericInterfaceNBVs();                             /* constructor */
        ~GenericInterfaceNBVs();                             /* constructor */
...
}; /* -----  end of class GenericInterfaceNBVs  ----- */

#endif   /* ----- #ifndef _GenericInterfaceNBVs_h_INC  ----- */

...
// TODO: adapt to manifold parameters
///////////////////////////////////////////////////////
...
//routing_type RT_ALGO  = DYAD;   //RTXY;		///< routing algorithm
//int  LOG = 0;				///< log level
...
int NUM_BUFS = buffer_size; //4;	///< buffer depth (number of buffers) in input channel fifo
int FLITSIZE = 131;	///< size of flit in bytes

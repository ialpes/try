...
#define PARM_Vdd              0.9 //1.0
#define PARM_Freq             1e9 //1.3e9
...
#define PARM_flit_width		132 //FLIT_WIDTH  //max_phy_link_bits //32	/* flit width in bits */

/* virtual channel parameters */
#define PARM_v_class        1   /* # of total message classes */
#define PARM_v_channel		4 //vcs //4	/* # of virtual channels per virtual message class*/
...
#define PARM_in_buf_set		8  // buffer_size // 8  /* buffer size */

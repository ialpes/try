...
#include "../orion_config/constants.h"
//#include "../orion_config/default.h"
#ifndef _SIM_PORT_H
#define _SIM_PORT_H

/*Technology related parameters */
#define PARM_TECH_POINT       65//90//110
#define PARM_TRANSISTOR_TYPE  NVT   /* transistor type, HVT, NVT, or LVT */
#define PARM_Vdd              1.1//1.2

////map

#define PARM_Freq             3.0e9 // here in hz while in nirgam in Ghz defined in nirgam.config as CLK_FREQ
...
#define PARM_out_share_switch	0	/* do output virtual channels share crossbar output ports? */
...
#define PARM_in_buf_set		NUM_BUFS /* # of buffers per virtual channel if no sharing (PARM_in_share_buf	0)*/ //int NUM_BUFS = 4;
